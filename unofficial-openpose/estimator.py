...
class TfPoseEstimator:
    ...
    def draw_humans(npimg, humans, imgcopy=False):
        ...
        for human in humans:
            # draw point
            '''
            rectangle = human.get_upper_body_box(1280,720)
            if rectangle!=None:
                cv2.rectangle(npimg, (rectangle['x'], rectangle['y']), (rectangle['x'] + rectangle['w'], rectangle['y'] + rectangle['h']),(255,0,0),2)
                '''
            ...
            #print(centers)
            #cv2.circle(npimg,centers[16],3,(0, 0, 255),2)
            person.append(centers.copy())
